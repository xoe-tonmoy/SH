...
module.exports.run = async function({ api, event }) {
  ...
  const botName = global.config.BOTNAME || "𝐓𝐨𝐧𝐦𝐨𝐘 𝐓𝐡𝐞 𝐁𝐨𝐭";

 
  if (event.logMessageData.addedParticipants.some(i => i.userFbId == api.getCurrentUserID())) {
    await api.changeNickname(`[ ${botPrefix} ] • ${botName}`, threadID, api.getCurrentUserID());

    api.sendMessage("চ্ঁলে্ঁ এ্ঁসে্ঁছি্ঁ 𝐓𝐨𝐧𝐦𝐨𝐘 𝐓𝐡𝐞 𝐁𝐨𝐭 এঁখঁনঁ তোঁমাঁদেঁরঁ সাঁথেঁ আঁড্ডাঁ দিঁবঁ..!", threadID, () => {
...
➤𝐌𝐞𝐬𝐬𝐞𝐧𝐠𝐞𝐫: https://m.me/100023401563213
➤𝐖𝐡𝐚𝐭𝐬𝐀𝐩𝐩: https://wa.me/90296280

❖⋆═══════════════════════⋆❖
          𝐁𝐨𝐭 𝐎𝐰𝐧𝐞𝐫 ➢ 𝐓𝐨𝐧𝐦𝐨𝐘 𝐓𝐡𝐞 𝐁𝐨𝐭`;
